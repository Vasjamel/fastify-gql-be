/*
  ...
  - A unique constraint covering the columns `[name]` on the table `Pupil` will be added. If there are existing duplicate values, this will fail.
...
*/
-- CreateIndex
CREATE UNIQUE INDEX "Pupil_name_key" ON "Pupil"("name");
